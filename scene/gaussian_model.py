...
class GaussianModel:
    ...
    def reset_opacity(self):
        ...
        for i in range(self.num_objs):
            ...
            print(self.get_xyz[i].isnan().sum())
            print(opacities_new[i].isnan().sum(), opacities_new[i].min(), opacities_new[i].max())
